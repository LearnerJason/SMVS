...
void CButtonST::OnLButtonDown(UINT nFlags, CPoint point) 
{
 ...
 //	::PostMessage( GetParent()->GetSafeHwnd(), WM_MONITOR_PTZ_LEFT_BTN_DOWN,
   //  (WPARAM)m_nButtonIndex, 0);
	if (m_bIsButton)
	{
...
void CButtonST::OnLButtonDblClk(UINT nFlags, CPoint point)
{
	if (m_bIsButton)
	{
...
void CButtonST::SetStaticButton(BOOL bStaticbutton)
{
	m_bIsButton = !bStaticbutton;
}
