...
private:
    ...
    Hobject m_rgnSmlCharS;            // 小字符
	Hobject m_rgnBigCharS;            // 大字符
	Hobject m_rgnPattern;             // 图案整体区域
	Hobject m_rgnTeeth;               // 一次提取的防伪齿整体区域
	Hobject m_rgnTeethWhiteRect;      // 防伪齿中的白色区域的外接矩形
	Hobject m_rgnCircle;              // 小圆区域
